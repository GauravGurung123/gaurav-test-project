...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit Personal Information') }}</div>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="/user/{{$user->id}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="bio" rows="3"  name="bio" >{{ old('bio') ?? $user['bio'] }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" type="file" id="formFile" name="image" value="{{ old('title') ?? $user['image']  }}">
